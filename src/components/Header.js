                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar">
                        <Nav className="me-auto">
                            ...
                            <Nav.Link href="#" className="mx-auto mx-lg-2 d-block d-lg-none"><Link to='/carts'>carts<span className="badge bg-primary ms-2">{`${(state.totalCount>0) ? state.totalCount : ""}`}</span></Link></Nav.Link>
                        ...
                        <div className="d-flex justify-content-center justify-content-lg-end">
                             <Nav.Link href="#" className="mx-auto mx-lg-2 d-none d-lg-block"><Link to='/carts'><i class="bi bi-cart2 fs-4"></i><span className="badge bg-primary ms-2 position-absolute top-1">{`${(state.totalCount>0) ? state.totalCount : ""}`}</span></Link></Nav.Link> 
                        </div>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
